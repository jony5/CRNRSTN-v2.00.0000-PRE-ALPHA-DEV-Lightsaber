            ...
            <li>
                <div class="crnrstn_general_post_recent_activity_shell">
                    ...
                    <div class="crnrstn_general_post_recent_activity_copy"><p>The project has received about twenty (20)
                        ...
                        <span style="font-family: Courier New, Courier, monospace;">$tunneling_active = false</span>
                        when calling <span style="font-family: Courier New, Courier, monospace;">$oC<span class="the_R_in_crnrstn">R</span>NRSTN->config_init_asset_mapping_js()</span>.
                        </p>
