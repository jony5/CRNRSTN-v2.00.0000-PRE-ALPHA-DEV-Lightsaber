...
if($SCRIPT_NAME=="/jony5mailingdb.inc.php"){
	...
	duty.";}else{
	 ...
	 # connect to database
	//
	// LOCALHOST DB CONNECTIVITY
	//mysql_connect("localhost","j5mailer","uJySGc6JuJrjneE2") or die (mysql_error()." - Database Server Connection Failed");
	//mysql_select_db('mailing_list') or die ("Database select failed");
