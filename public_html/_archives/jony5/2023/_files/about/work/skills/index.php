...
<body>
    ...
    <div id="content_wrapper">
    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div class="col" style="width:900px;">
           			<p>I enjoy animals and the outdoors. If I can mix both of these items 
                    with work...e.g. putting a presentation together from the comfort of 
                    a sunny patio or coding in a courtyard with my dog...all the better! 
                    As an Eagle Scout and Vigil honor brother in the Order of the Arrow, 
                    the connection that I have to the outdoors is respected, but I don't 
                    over do it. I've spent more than my fare share of time in the woods 
                    on official BSA organizational business. ^_^</p>
            ...
            <div class="content_copy">
            	<div class="col" style="width:900px;">
					<p>Does the contraption you're holding there have it's own 
                    mechanical system of operation? Can I see that when you get a sec?

                    <br><br>
                    Yes, I am a really big fan of the Transformers franchise...even 
                    since the 80's.</p>
