    	...
    	<div id="content">
        	<div class="content_copy">
            	<div class="col" style="width:900px;">
                    <p><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>downloads/resume/jharris_resume.pdf" target="_self">Click here</a> to download.</p>
                </div>
            </div>
