...
<body>
	...
	<div class="cb"></div>
    <!-- LIFESTYLE BANNER -->
	<div id="banner_lifestyle_wrapper" style="background-image:url(<?php echo $tmp_http_root; ?>common/imgs/wood.jpg);">
        <div id="banner_button_wrapper">
            <div id="banner_button_wrapper_inner">
                <div id="banner_button_bg_wrapper">
                    <div id="banner_button_click" onclick="toggle_banner_mode(); return false;"></div>
                    ...
                    <div id="banner_control_play_wrapper" style="display: none;">
                        <div class="banner_play_arrow"></div>
                    </div>

                    <div id="banner_button_bg_border"></div>
                    <div id="banner_button_bg"></div>
                </div>
            </div>
        </div>
    	<div id="banner_lifestyle">
			...
			require($tmp_root_path . '/common/inc/lifestyle/banner.inc.php');
    ...
    <div id="content_wrapper">
    	<div id="vert_nav_wrapper">
            ...
            <div class="vert_nav_lnk_wrapper"><a href="<?php echo $tmp_http_root; ?>projects/polarbear/90daybuildout/wrap/" target="_self">wrap</a></div>
