...
<div id="body_wrapper">
    ...
    <div id="content_wrapper">
    	<div id="vert_nav_wrapper">
    		...
    		<div class="vert_nav_lnk_wrapper"><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>projects/polarbear/90daybuildout/audio/" target="_self">audio</a></div>
            <div class="vert_nav_lnk_wrapper sel">performance</div>
    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div style="width:700px;">
                    <div class="cb"></div>
                    <?php
                    $dir_path = "common/imgs/dart/performance/";
