    ...
    <div id="content_wrapper">
    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div class="col">
           			<p>Over or under-feeding your prize females is one of the easiest 
                    ways to reduce the productivity of your grow operation. The weakening 
                    of the plants that would result from an imbalanced and inconsistent 
                    diet also opens the door for the introduction of other complications 
                    such as disease, mold and pest infestations.</p>

            	</div>
                <div class="col">
                	<p>Monitoring the operation of your nutrient delivery systems 
                    (including a running pH check on your nutrient solutions) is a great 
                    way to inspect what you expect with respect to meeting your plants 
                    daily nutritional needs. Whether you have automated pumps or practice 
                    watering by hand, keeping a</p>

                </div>
				<div class="col">
                	<p>running tab on specs such as feeding frequency/times and nutrient 
                    solution pH levels will allow you to more closely monitor and control 
                    these variables.  Any necessary adjustments can then be made sooner 
                    rather than later.  Your ladies will thank you in the long run!</p>
