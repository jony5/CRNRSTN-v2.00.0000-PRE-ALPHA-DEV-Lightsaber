    ...
    <div id="content_wrapper">
    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div class="col">
           			<p>I'm putting together an open source PHP class library primarily in order to facilitate the mapping of n+1 environmentally specific parameters to an application. 
                    So when the codebase is released from one hosting environment to the next (e.g. going from stage to preproduction or localhost to stage), the application will &quot;know&quot; which
                    environment it is running in, and it will use the appropriate parameters.</p>
                    <p><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>dgf/crnrstn/" target="_blank"><img src="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>common/imgs/crnrstn_logo.gif" width="198" height="103" alt="CRNRSTN ::" title="CRNRSTN ::"></a></p>
                    <p><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>dgf/crnrstn/" target="_blank">Click here</a> to sign up to receive an email alert when the class library becomes available. You'll only receive that one email from me.</p>
                    
            	</div>
                <div class="col">
                	<p>The C<span style="color:#F00;">R</span>NRSTN Suite :: will also provide the ability to apply a layer of encryption to both session and/or cookie data as well as apply 
                    IPv4 and/or IPv6 address access restrictions.</p>
                	<p>When I entered the workforce as an HTML developer (after the start up companies), I used PHP on the side to put together various portals and tools for 
                        ...
                        <p>I needed a class library that would support and standardize fundamental architectural and operational requirements.</p>
                </div>
				<div class="col">
                	<p>It also needed to be capable of performing flawlessly (read as fast and light) in some of the most brutal hosting/traffic environments known to man.</p>
                	<p>Since transitioning out of the agency job, I have had the opportunity (and the time!) to roll up my sleeves and jump knee deep
                        ...
                        my web development (LAMP stack) projects. The C<span style="color:#F00;">R</span>NRSTN Suite :: will be the culmination of years of contemplative thought, many hours spent in application testing &amp; development, 
                        countless cups of coffee and a hint of marijuana.</p>
                </div>
            ...
            <div class="content_copy">
            	<div class="col">
           			<p>In ancient times, a home could be constructed using large stone pieces to provide key support to the structure at the foundation, corners and top. A cornerstone, therefore, is the joining piece that connects together two walls of a house. Also, the foundation stone and roof (topstone) would be connected at the corners.</p>
                	<p><strong>Pro Tip (Christian)</strong> :: When Jesus came, He came as the reality of the cornerstone (the real cornerstone) joining the "wall" of the Jewish believers to the "wall" of the gentile believers together in the building of the church.</p>
                </div>
                <div class="col">
                	<p>Jesus is the Cornerstone (Eph. 2:20, 1 Peter 2:6) in the building of the Father's house...the church...joining all of God's people together in Himself.</p>
					<p>According to the footnote 3 on Eph. 2:20 in my <a href="http://biblesforamerica.org/free-bible/" target="_blank">Recovery Version</a> study Bible, when the Jewish builders rejected Christ, they rejected Him as the cornerstone (Acts 4:11; 1 Pet. 2:7), the One who would join the Gentiles to them for the building of God's house.</p>
                </div>
                <div class="col">
					<p>Well, to liken the act of building a house to the process of coding a web application...or I should say rather...in elegantly correlating web application requirements for portability under rigid release to manufacturing (RTM) processes to the simple illustration of a cornerstone joining the "wall of server" to the "wall of application", I have taken a modern technology staple and cast it under the warm analogue glow of the ancient world of house building.</p>
                </div>
            </div>
