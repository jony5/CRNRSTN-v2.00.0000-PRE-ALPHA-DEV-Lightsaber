...
for($i=0; $i<$tmp_loop_size; $i++){
    ...
    if($tmp_mini_profile_id==$tmp_profile_id){
        ...
        $tmp_mini_timer_state = $oDB_RESP->return_data_element($oDB_RESP->return_serial($tmp_serial_handle), 'OVERLAY_MGMT', 'MINI_TIMER_STATE');
...
<body>
    <div class="main_content_wrapper">
        ...
        switch($tmp_mini_state){
            case '0':
                // HIDDEN MINI OVERLAY
                ?>
                <div class="admin_section_title">Manage Mini Overlay</div>
                <div class="mgmt_lnk_btn" onclick="applyUpdate(this);" avreqid="show_overlay">SHOW OVERLAY</div>
                <?php
            break;
            case '1':
            ?>
        ...
        if($tmp_mini_state>0){
            ...
            switch($tmp_mini_timer_state){
                case '0':
                    // HIDDEN TIMER
            ?>
                    <div class="cb_30"></div>
                    <div class="admin_section_title">Timer Controls</div>
                    <div class="mgmt_lnk_btn" onclick="applyUpdate(this);" avreqid="showtmr">SHOW TIMER</div>
                <?php
                break;
                case '1':
                    ?>
                    ...
                    <div class="mgmt_lnk_btn" onclick="applyUpdate(this);" avreqid="hidetmr_p">HIDE TIMER AND PAUSE</div>
                <?php
                break;
            }
        }
