    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div class="col" style="width:900px;">
                	<p>Click <a href="#" target="_blank" onClick="launch_popup('<?php echo $tmp_http_root; ?>social/fellowship/podcast/listen.php','500','340','lsm_aud')">here</a> 
                    to listen to the radio program entitled <em><?php echo  $lsm_podcast_ARRAY[0][0]; ?></em>.</p>
                    <div id="podcast_listen_wrapper">
                    	<div id="podcast_listen_btn" onClick="launch_popup('<?php echo $tmp_http_root; ?>social/fellowship/podcast/listen.php','500','340','lsm_aud')">LISTEN</div>
                		<div id="podcast_listen_icon" onClick="launch_popup('<?php echo $tmp_http_root; ?>social/fellowship/podcast/listen.php','500','340','lsm_aud')"><img src="<?php echo $tmp_http_root; ?>common/imgs/listen_icon.png" width="29" height="28" alt="Listen" title="Speaker" /></div>
                    	<div class="cb"></div>
                    </div>
                    <div class="cb_10"></div>
                    <p><strong>Life-Study of the Bible with Witness Lee</strong> is 
                    a 30-minute radio broadcast composed of excerpts from 
                    Witness Lee's spoken ministry that focuses 
                    on the enjoyment of the divine life as revealed in the 
                    Scriptures. The ministry portions are followed by a discussion 
                    of the portion presented, including questions and answers.</p>

                    <p>This radio broadcast is now available as a podcast. Listen 
                    to a new podcast every day!</p>
            ...
            <div class="content_copy">
            	<div class="col" style="width:900px;">
           			<p>To automatically receive future podcats to your RSS reader, 
                        follow these instructions:
                        <ul>
                            <li>Right-click on the RSS feed icon here <a href="http://www.lsmradio.com/rss/today.rss" target="_blank"><img src="<?php echo $tmp_http_root; ?>common/imgs/icon_rss.gif" width="30" height="30" alt="RSS" title="RSS"></a></li>
