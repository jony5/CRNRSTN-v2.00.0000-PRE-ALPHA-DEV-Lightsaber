...
<body>
    ...
    <div id="content_wrapper">
    	<div id="vert_nav_wrapper">
    		...
    		<div class="vert_nav_lnk_wrapper sel">linkedin</div>
    	...
    	<div id="content">
            ...
            <div class="content_copy">
            	<div class="col" style="width:900px;">
           			<p>Click <a href="https://www.linkedin.com/in/j00000101/" target="_blank">here</a> 
                    to view my profile. When last I checked, if you have an account with 
                    LinkedIn<sup style="font-size:60%;">&reg;</sup>, you can view my full profile 
                    for free.</p>
