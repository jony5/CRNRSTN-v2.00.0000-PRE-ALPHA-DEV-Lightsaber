...
$tmp_http_path = $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP') . $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR');
...
switch($_SERVER['SCRIPT_NAME']){
    ...
    <link rel="shortcut icon" type="image/x-icon" href="' . $tmp_http_path . 'favicon.ico?v=420" />
...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $tmp_http_path; ?>favicon.ico?cache_v=420" />
<meta name="distribution" content="Global" />
<meta name="robots" content="index,follow" />
<meta name="twitter:image:src" content="<?php echo $tmp_http_path; ?>common/imgs/social_share/preview/<?php echo $social_img; ?>" />
<meta name="twitter:site" content="@jony5" />
<meta name="twitter:card" content="summary_large_image" />
...
<meta property="og:image" content="<?php echo $tmp_http_path; ?>common/imgs/social_share/preview/<?php echo $social_img; ?>" />
...
<link rel="stylesheet" href="<?php echo $tmp_http_path; ?>common/js/_lib/frameworks/jquery_ui/1.12.1/jquery-ui.min.css" />
<link rel="stylesheet" href="<?php echo $tmp_http_path; ?>common/css/main.css?cache_v=420.00<?php echo filesize($tmp_root_path . '/common/css/main.css') . '.' . filemtime($tmp_root_path . '/common/css/main.css') . '.0'; ?>" type="text/css" />
<link rel="stylesheet" href="<?php echo $tmp_http_path; ?>common/js/_lib/frameworks/lightbox/2.11.1/css/lightbox.min.css" type="text/css" />
<script src="<?php echo $tmp_http_path; ?>common/js/_lib/frameworks/jquery_mobi/jquery.js"></script>
<script src="<?php echo $tmp_http_path; ?>common/js/_lib/frameworks/jquery_ui/1.12.1/jquery-ui.min.js"></script>
<script type="text/javascript" language="javascript" src="<?php echo $tmp_http_path; ?>common/js/_lib/frameworks/jquery/3.4.1/jquery-3.4.1.min.js" ></script>
<script type="text/javascript" language="javascript" src="<?php echo $tmp_http_path; ?>common/js/main.js?cache_v=420.00<?php echo filesize($tmp_root_path . '/common/js/main.js') . '.' . filemtime($oCRNRSTN_ENV->getEnvParam('DOCUMENT_ROOT') . $oCRNRSTN_ENV->getEnvParam('DOCUMENT_ROOT_DIR') . '/common/js/main.js') . '.0'; ?>"></script>
<?php
/*
<!--
<script type="text/javascript" language="javascript" src="<?php echo $tmp_http_path; ?>common/js/form/form.js"></script>-->
*/
?>
<!-- Google tag (gtag.js) -->
