...
function initPageContent(){
	...
	//
	// LOAD URL REQUESTED PAGE OR SHOW WELCOME PAGE
	update_content_primary(requestedmodule);
...
function active_link(pagename){
	//
	// SET ALL LINKS TO OFF
	$("tnav_administration").innerHTML="" ;
	$("tnav_creative").innerHTML="" ;
	$("tnav_reporting").innerHTML="" ;
	$("tnav_documentation").innerHTML="" ;
	$("tnav_ecrm101").innerHTML="" ;
	
	//
	// ACTIVATE
	$("tnav_"+[pagename]).innerHTML="<img src='imgs/nav_"+pagename+".gif' width='241' height='24' alt='"+pagename+"' title='"+pagename+"' />" ;
...
function deliverability_submit(){
	...
	if(validEmail(email) && validReqField(myhtml)){
		...
		//
		// SHOW PROCSSING
		$("dynform_response").innerHTML="<div style='padding:50px; padding-left:60px;'><div class='cb'></div><img src='imgs/long_loader.gif' width='220' height='19' alt='Loading...' /></div>";	
