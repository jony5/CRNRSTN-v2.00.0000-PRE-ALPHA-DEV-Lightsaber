...
logActivity('404 error',crc32('404 error'), $UNHASH, $MNHASH, $PWDHASH, $IPLASTLOGIN, $USERAGENT);
...
<div class="hometitle">We're sorry. That request could not be processed.<br>Please <a href="../">click here</a> to return for more wethr.</div>
