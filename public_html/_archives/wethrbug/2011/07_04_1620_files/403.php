...
logActivity('403 error',crc32('403 error'), $UNHASH, $MNHASH, $PWDHASH, $IPLASTLOGIN, $USERAGENT);
...
<div class="hometitle">We're sorry. You do not have permission for this request.<br>Please <a href="../">click here</a> to return for more wethr.</div>
