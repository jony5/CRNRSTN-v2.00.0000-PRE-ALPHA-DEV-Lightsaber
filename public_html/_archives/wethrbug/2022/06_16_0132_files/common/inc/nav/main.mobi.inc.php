	<div data-role="panel" id="leftpanel_nav">
    	<div style="float:left; padding:5px; padding-bottom:0px;background-color:#FFF; margin:5px; border:2px solid #BDB2B3;"><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR') ?>" data-ajax="false">[image_here?]</a></div>
        ...
        <div class="cb_10"></div>
        <div style="float:right; position:absolute;left:150px;">[image_here?]</div>
