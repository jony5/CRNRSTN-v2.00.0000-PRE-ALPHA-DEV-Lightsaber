            ...
            switch($oCRNRSTN_ENV->oSESSION_MGR->getSessionParam('USER_PERMISSIONS_ID')) {
                case '50':
                    ...
                    <div data-role="collapsible" style="padding-top:20px;">
                        ...
                        <ul data-role="listview" data-theme="b">
                            <li><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP') . $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR') ?>admin/hexcolors/" data-ajax="false">Colors</a></li>
                            <li><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP') . $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR') ?>admin/componenttypes/" data-ajax="false">Components</a></li>
                            <li><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP') . $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR') ?>admin/usertypes/" data-ajax="false">User Types</a></li>
