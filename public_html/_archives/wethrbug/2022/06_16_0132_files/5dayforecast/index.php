        ...
        <div role="main" class="ui-content">
            ...
            <div id="xygrid_forecast_output"><?php
                ...
                if($oUSER->wthrbg_xygrid_uri!=""){
                    ...
                    echo '<a href="'.$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR').'" target="_self" data-ajax="false" style="color:#0066CC;">Click here</a> for wethr lookup.';
                }
