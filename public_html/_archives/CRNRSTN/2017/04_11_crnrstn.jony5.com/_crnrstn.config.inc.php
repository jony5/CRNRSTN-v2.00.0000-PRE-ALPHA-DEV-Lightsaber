...
$oCRNRSTN->initSessionEncryption('LOCALHOST_MAC', '6');					// EXAMPLE OF INITIALIZATION WITH A SPECIFIC CIPHER NAME
...
#error_log("_crnrstn.config.inc.php (234) About to check for session config initialization...");
