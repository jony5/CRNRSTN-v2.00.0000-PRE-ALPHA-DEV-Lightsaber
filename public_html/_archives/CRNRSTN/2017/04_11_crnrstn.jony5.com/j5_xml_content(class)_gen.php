...
try{
	for($i=0; $i<sizeof($result_ID_ARRAY); $i++){
		...
		$xml_method_open = '<?xml version="1.0" encoding="iso-8859-1"?><crnrstn_pagecontent><crnrstn_element><crnrstn_contenttype>c</crnrstn_contenttype>';
		...
		$xml_method_output_str = '<crnrstn_contenttype>c</crnrstn_contenttype><crnrstn_title uri="'.$soap_resp_URI.'">'.XML_sanitize($soap_resp_NAME).' ::</crnrstn_title><crnrstn_description>'.XML_sanitize($soap_resp_DESCRIPTION).'</crnrstn_description><crnrstn_version>'.XML_sanitize($soap_resp_VERSION).'</crnrstn_version>';
