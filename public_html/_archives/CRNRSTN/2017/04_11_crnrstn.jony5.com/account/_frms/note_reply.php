...
<body>
<div class="form_shell" style="width:700px;">
	<form action="#" method="post" name="post_comment_reply" id="post_comment_reply"  enctype="multipart/form-data" >
									...
									<div class="form_input_shell">
										...
										<td valign="top">
											...
											<div class="form_input_shell">
												...
												<div class="cb"></div>
												<div class="input_validation_copy_shell"><div id="subject_input_validation_copy" class="input_validation_copy"></div></div>
												<div class="cb"></div>
												</div>
											</div>
											...
											<div id="note_submit_shell" class="admin_submit_shell">
												<div class="form_submit_btn" onMouseOver="submitBtnMouseOver(this); return false;" onMouseOut="submitBtnMouseOut(this); return false;" onClick="if(mycrnrstn_fhandler.validateForm('post_comment_reply')){ $('post_comment_reply').submit()}">Submit</div>
											</div>
											</td>
											</tr>
											</table>
							...
							<div class="hidden">
								...
								<input type="hidden" name="un" id="un" value="<?php echo $oUSER->getUserParam('USERNAME'); ?>">
                                ...
                                <input type="hidden" name="nid_replyto" id="nid_replyto" value="<?php echo $oENV->oHTTP_MGR->extractData($_GET, 'nid_replyto'); ?>">
