...
class database_integration {
	...
	public function svc_getAccntInfo($oUser, $oUserEnvironment, $contentType){
		return $this->dbQuery($contentType, $oUserEnvironment, $oUser);
	}
	...
	private function dbQuery($queryType, $oUserEnvironment, $oUser){
		try{
			error_log('/crnrstn/ database.mgmt.inc.php (140) queryType sent to database :: '.$queryType);
