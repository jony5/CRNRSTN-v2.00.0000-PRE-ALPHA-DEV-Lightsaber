...
try{
	...
	'SOAP_REQUEST','".$_SERVER['SCRIPT_NAME']."','".$_SERVER['HTTP_USER_AGENT']."','".$_SERVER['HTTP_REFERER']."','".$mysqli->real_escape_string($oENV->oHTTP_MGR->getHeaders('string'))."','".$_SERVER['REQUEST_METHOD']."','".$_SERVER['REMOTE_ADDR']."');";
