...
if($pos!==false){
	...
	if($oENV->oHTTP_MGR->issetHTTP($_POST)){
		$oENV->oSESSION_MGR->setSessionParam('TIMESPAN', $adminContent_ARRAY['TIMESPAN']);
		$oENV->oSESSION_MGR->setSessionParam('SEARCH', $adminContent_ARRAY['SEARCH_PARAM']);
		$tmp_TIMESPAN = $adminContent_ARRAY['TIMESPAN'];
		$tmp_SEARCH = $adminContent_ARRAY['SEARCH_PARAM'];

		//
		// UPDATE SESSION :: COMMUNICATIONS
		$oENV->oSESSION_MGR->setSessionParam('FEEDBACK_SOURCE', $adminContent_ARRAY['FEEDBACK_SOURCE']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_SPAM', $adminContent_ARRAY['COMM_FB_FILTER_SPAM']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_OPTIN', $adminContent_ARRAY['COMM_FB_FILTER_OPTIN']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_GENCOMM', $adminContent_ARRAY['COMM_FB_FILTER_GENCOMM']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_GENQUEST', $adminContent_ARRAY['COMM_FB_FILTER_GENQUEST']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_FEATREQ', $adminContent_ARRAY['COMM_FB_FILTER_FEATREQ']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_BUGREPORT', $adminContent_ARRAY['COMM_FB_FILTER_BUGREPORT']);
		$oENV->oSESSION_MGR->setSessionParam('COMM_FB_FILTER_RESPONDED', $adminContent_ARRAY['COMM_FB_FILTER_RESPONDED']);
		...
		$tmp_TIMESPAN = $oENV->oSESSION_MGR->getSessionParam('TIMESPAN');
		$tmp_SEARCH = $oENV->oSESSION_MGR->getSessionParam('SEARCH_PARAM');

		//
		// UPDATE SESSION :: COMMUNICATIONS
		$tmp_COMM_FB_SOURCE = $oENV->oSESSION_MGR->getSessionParam('FEEDBACK_SOURCE');
		$tmp_COMM_FB_FILTER_SPAM = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_SPAM');
		$tmp_COMM_FB_FILTER_OPTIN = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_OPTIN');
		$tmp_COMM_FB_FILTER_GENCOMM = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_GENCOMM');
		$tmp_COMM_FB_FILTER_GENQUEST = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_GENQUEST');
		$tmp_COMM_FB_FILTER_FEATREQ = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_FEATREQ');
		$tmp_COMM_FB_FILTER_BUGREPORT = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_BUGREPORT');
		$tmp_COMM_FB_FILTER_RESPONDED = $oENV->oSESSION_MGR->getSessionParam('COMM_FB_FILTER_RESPONDED');
	}
}else{
	...
	if($oENV->oHTTP_MGR->issetHTTP($_POST)){
		...
		$oENV->oSESSION_MGR->setSessionParam('FILTER_LOCKED', $adminContent_ARRAY['FILTER_LOCKED']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_PUBLICNOTE', $adminContent_ARRAY['FILTER_PUBLICNOTE']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_PUBLISHME', $adminContent_ARRAY['FILTER_PUBLISHME']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_CENSOREDACCNT', $adminContent_ARRAY['FILTER_CENSOREDACCNT']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_DELETEDACCNT', $adminContent_ARRAY['FILTER_DELETEDACCNT']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_CENSOREDNOTE', $adminContent_ARRAY['FILTER_CENSOREDNOTE']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_NOTES', $adminContent_ARRAY['FILTER_NOTES']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_LIKES', $adminContent_ARRAY['FILTER_LIKES']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_REPLIEDTO', $adminContent_ARRAY['FILTER_REPLIEDTO']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_REPLIES', $adminContent_ARRAY['FILTER_REPLIES']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_CODE', $adminContent_ARRAY['FILTER_CODE']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_LOGGEDIN', $adminContent_ARRAY['FILTER_LOGGEDIN']);
		$oENV->oSESSION_MGR->setSessionParam('FILTER_USRDELETED', $adminContent_ARRAY['FILTER_USRDELETED']);
		$oENV->oSESSION_MGR->setSessionParam('ACCOUNT_STATUS', $adminContent_ARRAY['ACCOUNT_STATUS']);
		...
		//
		// UPDATE SESSION :: USER ADMINISTRATION
		$tmp_FILTER_LOCKED = $oENV->oSESSION_MGR->getSessionParam('FILTER_LOCKED');
		$tmp_FILTER_PUBLICNOTE = $oENV->oSESSION_MGR->getSessionParam('FILTER_PUBLICNOTE');
		$tmp_FILTER_PUBLISHME = $oENV->oSESSION_MGR->getSessionParam('FILTER_PUBLISHME');
		$tmp_FILTER_CENSOREDACCNT = $oENV->oSESSION_MGR->getSessionParam('FILTER_CENSOREDACCNT');
		$tmp_FILTER_DELETEDACCNT = $oENV->oSESSION_MGR->getSessionParam('FILTER_DELETEDACCNT');
		$tmp_FILTER_CENSOREDNOTE = $oENV->oSESSION_MGR->getSessionParam('FILTER_CENSOREDNOTE');
		$tmp_FILTER_NOTES = $oENV->oSESSION_MGR->getSessionParam('FILTER_NOTES');
		$tmp_FILTER_LIKES = $oENV->oSESSION_MGR->getSessionParam('FILTER_LIKES');
		$tmp_FILTER_REPLIEDTO = $oENV->oSESSION_MGR->getSessionParam('FILTER_REPLIEDTO');
		$tmp_FILTER_REPLIES = $oENV->oSESSION_MGR->getSessionParam('FILTER_REPLIES');
		$tmp_FILTER_CODE = $oENV->oSESSION_MGR->getSessionParam('FILTER_CODE');
		$tmp_FILTER_LOGGEDIN = $oENV->oSESSION_MGR->getSessionParam('FILTER_LOGGEDIN');
		$tmp_FILTER_USRDELETED = $oENV->oSESSION_MGR->getSessionParam('FILTER_USRDELETED');
		$tmp_ACCOUNT_STATUS = $oENV->oSESSION_MGR->getSessionParam('ACCOUNT_STATUS');
	}
}
?>
