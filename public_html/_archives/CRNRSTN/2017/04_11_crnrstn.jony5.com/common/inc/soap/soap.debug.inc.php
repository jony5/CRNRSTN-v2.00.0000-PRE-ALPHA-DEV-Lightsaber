...
// IF USER IS AUTHENTICATED, PROVIDE SIGN OUT URI...NOT SIGN IN
	...
	if($oUSER->returnSoapFault()){
		...
		if ($err) {
			...
			echo '<div class="cb_15"></div><h3 class="content_results_subtitle">Web Services Result (Content) ::</h3>';
	...
	echo '<div class="cb_15"></div><h3 class="content_results_subtitle">SOAP Request Details (Content) ::</h3>';
	...
	echo '<h3 class="content_results_subtitle">SOAP Response Details (Content) ::</h3>';
	echo '<div class="content_results_subtitle_divider"></div>';
	...
	echo '<h3 class="content_results_subtitle">SOAP Debug (Content) ::</h3>';
	echo '<div class="content_results_subtitle_divider"></div>';
