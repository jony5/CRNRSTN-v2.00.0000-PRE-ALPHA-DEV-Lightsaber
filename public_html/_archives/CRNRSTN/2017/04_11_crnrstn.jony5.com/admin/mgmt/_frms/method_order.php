...
<div class="form_shell">
	<form action="#" method="post" name="order_method" id="order_method"  enctype="multipart/form-data" >
	<div class="main_form_wrapper" style="width:500px;">
		...
		<div class="input_shell_wrapper">
			...
			<div class="form_input_shell">
				<div class="form_element_input" style="float:left;">
					<div style="margin:5px 5px 2px 0; float:left; display:block; width:200px;">
						<input crnrstn_frm_valtype="none" id="method_order<?php echo $i; ?>" name="method_order<?php echo $i; ?>" type="text" value="<?php echo $i; ?>" style="width:15px;">
						<span class="form_element_label" style="text-align:left; margin:5px; margin-top:0px; width:150px; cursor:pointer;"><?php echo $oUSER->contentOutput_ARRAY[1]['METHODS'][$i]['NAME'] ?></span>
					</div>
				</div>
			...
			<div id="submit_shell" class="admin_submit_shell">
				<div class="form_submit_btn" onMouseOver="submitBtnMouseOver(this); return false;" onMouseOut="submitBtnMouseOut(this); return false;" onClick="if(mycrnrstn_fhandler.validateForm('order_method')){ $('order_method').submit()}">Submit</div>
			</div>
			<div class="cb_5"></div>
		</div>
		</div>
