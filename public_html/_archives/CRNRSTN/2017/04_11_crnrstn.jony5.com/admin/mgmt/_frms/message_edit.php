...
<div class="form_shell">
	<form action="#" method="post" name="edit_message" id="edit_message"  enctype="multipart/form-data" >
    <?php
	for($i=0;$i<sizeof($adminContent_ARRAY);$i++){
		if($adminContent_ARRAY[$i]['MSG_KEYID']==$oENV->oHTTP_MGR->extractData($_GET, 'key')){
	?>
	<div class="main_form_wrapper" style="width:500px;">
		...
		<div class="form_input_shell">
				...
				<div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="msgkey" type="text" id="msgkey" size="20" maxlength="100" value="<?php echo $adminContent_ARRAY[$i]['MSG_KEYID']; ?>" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);" /></div>
				<div class="cb"></div>
			...
			<div class="form_input_shell">
				...
				<div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="msgname" type="text" id="msgname" size="20" maxlength="100" value="<?php echo $adminContent_ARRAY[$i]['MSG_NAME']; ?>" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);" /></div>
				<div class="cb"></div>
			...
			<div class="form_input_shell">
				...
				<div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="msgsubject" type="text" id="msgsubject" size="20" maxlength="100" value="<?php echo $adminContent_ARRAY[$i]['MSG_SUBJECT']; ?>" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);" /></div>
				<div class="cb"></div>
			...
			<div class="form_input_shell">
				...
				<div class="form_element_input">
					<textarea frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="none" name="msgdescription" id="msgdescription" cols="50" rows="4" wrap="off" style="width:365px;" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);"><?php echo $oUSER->cleanMySQLEscapes($adminContent_ARRAY[$i]['MSG_DESCRIPTION']); ?></textarea>
				</div>
				<div class="cb"></div>
			...
			<div class="form_input_shell">
				...
				<div class="form_element_input">
					<textarea frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="msghtml" id="msghtml" cols="50" rows="4" wrap="off" style="width:365px;" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);"><?php echo $oUSER->cleanMySQLEscapes($adminContent_ARRAY[$i]['MSG_HTML']); ?></textarea>
				</div>
				<div class="cb"></div>
			...
			<div class="form_input_shell">
				...
				<div class="form_element_input">
					<textarea frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="msgtext" id="msgtext" cols="50" rows="4" wrap="off" style="width:365px;" onBlur="mycrnrstn_fhandler.leavingListenerAdmin(this);"><?php echo $oUSER->cleanMySQLEscapes($adminContent_ARRAY[$i]['MSG_TEXT']); ?></textarea>
				</div>
				<div class="cb"></div>
			...
			<div id="submit_shell" class="admin_submit_shell">
				<div class="form_submit_btn" onMouseOver="submitBtnMouseOver(this); return false;" onMouseOut="submitBtnMouseOut(this); return false;" onClick="if(mycrnrstn_fhandler.validateForm('edit_message')){ $('edit_message').submit()}">Submit</div>
			</div>
			<div class="cb_5"></div>
		</div>
		</div>
