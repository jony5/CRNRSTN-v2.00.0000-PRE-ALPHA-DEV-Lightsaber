...
<div class="form_shell">
	<form action="#" method="post" name="edit_class" id="edit_class"  enctype="multipart/form-data" >
	<div class="main_form_wrapper" style="width:500px;">
		...
		<div class="input_shell_wrapper">
			...
			<div class="form_input_shell" style="float:left;">
				<div class="form_element_input" style="float:left; border:2px solid #FF0000;">
						<div style="margin:5px 5px 2px 20px; float:left; display:block; width:200px;">
							<input crnrstn_frm_valtype="none" id="class_remove_chk" name="class_remove_chk" type="checkbox" value="1" style="width:15px;">
							<span onClick="checkMe('class_remove_chk'); return false;" class="form_element_label" style="text-align:left; margin:5px; margin-top:0px; width:150px; cursor:pointer;">Delete this class.</span>
						</div>
				</div>
			<div class="form_submit_btn" style="float:right;" onMouseOver="submitBtnMouseOver(this); return false;" onMouseOut="submitBtnMouseOut(this); return false;" onClick="if(mycrnrstn_fhandler.validateForm('edit_class')){ $('edit_class').submit()}">Save</div>
			</div>
