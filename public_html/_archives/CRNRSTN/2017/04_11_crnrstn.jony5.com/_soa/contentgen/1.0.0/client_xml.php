...
<?php require('_seocontent.inc.php'); ?>
			...
			<div id="doc_content_results_wrapper">
				<div id="doc_content_results">
					...
					<div id="content_results_body">
						...
						<p id="xhandle_methoddefine"><?php if($tmp_dataMode[1]=='SOAP'){ $tmp_param_cnt = sizeof($oUSER->contentOutput_ARRAY[1]['PARAMETERS']); echo $oUSER->contentOutput_ARRAY[1]['METHODDEFINE'];} ?></p>
						<?php if($tmp_dataMode[1]=='XML' || $tmp_param_cnt > 0){ ?>
						<div class="cb_15"></div>
