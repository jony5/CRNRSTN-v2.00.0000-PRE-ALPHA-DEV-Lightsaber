...
#error_log("/services/ index.php (8) Value for DOCUMENT_ROOT: ".$oUSER->getEnvParam('DOCUMENT_ROOT')." and _CRNRSTN_ENV_KEY :: ".$_SESSION['jRs72bd0'.'CRNRSTN'.crc32('_CRNRSTN_ENV_KEY')]);
#require($oUSER->getEnvParam('DOCUMENT_ROOT').'/services/common/classes/webservice.inc.php');
require($oUSER->getEnvParam('DOCUMENT_ROOT').'/common/classes/webservice.inc.php');
...
function searchResultsSuggest($soapRequest) {
	...
	#error_log("/services/wsdl/ Prepared response");
	return $SERVICE_RESPONSE;
}
