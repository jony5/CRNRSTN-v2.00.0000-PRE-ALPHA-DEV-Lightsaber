...
class wsdl extends nusoap_base {
	...
	*/
	...
	function serializeRPCParameters($operation, $direction, $parameters, $bindingType = 'soap') {
		$this->debug("inN serializeRPCParameters: operation=$operation, direction=$direction, XMLSchemaVersion=$this->XMLSchemaVersion, bindingType=$bindingType");
		...
		$this->debug('in serializ!eRPC!Parameters: opData:');
		...
		if (isset($opData[$direction]['parts']) && sizeof($opData[$direction]['parts']) > 0) {
			...
			$this->debug("we have $part_count part(s) to serialize using $style/$use");
			...
			//
			// ##TESTING FOR DROPPED PARAMETERS #J509.28.2014##
	...
	{
		$this->debug("in sSerializeParameters: operation=$operation, direction=$direction, XMLSchemaVersion=$this->XMLSchemaVersion"); 
		$this->appendDebug('parameters=' . $this->varDump($parameters));
