...
class mysql_connection {
	...
	*/
	...
	function mysqli_result_lengths(){
	##
	...
	*/
	...
	private static function another_example_of_multiple_queries_interate_through_multi_results(){
		/*
	...
	*/
	...
	private static function set_connection_charset(){
	...
	*/
	...
	private static function sql_injection_example(){
	## 
	## http://www.php.net/manual/en/mysqli.quickstart.multiple-statement.php
	/*
		$mysqli = new mysqli("example.com", "user", "password", "database");
	...
	*/
	...
	private static function accessing_result_set_metadata_in_db_results(){
	...
	*/
	...
	private static function prepared_statement_execution_and_metadata(){
	## 
	## http://www.php.net/manual/en/mysqli.quickstart.metadata.php
	/*
