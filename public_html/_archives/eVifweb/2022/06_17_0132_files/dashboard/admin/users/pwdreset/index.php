...
$tmp_loop_size18 = sizeof($adminContent_ARRAY);
for($i=0;$i<$tmp_loop_size18;$i++){
...
<div data-role="page" id="myPage">
    ...
    <?php 
	if($oUSER->responseString=="pwd_reset=success"){
	?>	
	<!-- 
    //
    // BEGIN MAIN CONTENT -->
	<div role="main" class="ui-content">
		<h3>Success</h3>
		<p>The user has been flagged to recieve a password reset email from the system.</p>
		<div class="cb_10"></div>
	...
	<?php	
        ...
        <div role="main" class="ui-content">
            <h3>Error</h3>
            <p>An error was experienced when the system attempted to flag the user for password reset.</p>
            <div class="cb_10"></div>
            <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/users/settings/?uid=".$tmp_userData['USERID'];  ?>" class="ui-btn ui-icon-back ui-btn-icon-left ui-corner-all">Back to User</a>
    ...
    // BEGIN MAIN CONTENT -->
	<div role="main" class="ui-content">
		<h3>reset password for <?php echo $tmp_userData['FIRSTNAME_BLOB']." ".$tmp_userData['LASTNAME_BLOB']; ?></h3>
		<p>Do you wish to immediately trigger a password reset email to this user?</p>
		<div class="cb_10"></div>
      	<form action="#" method="post" name="admin_triggered_pwd_reset" id="admin_triggered_pwd_reset"  enctype="multipart/form-data" data-ajax="false">				
            
            <button class="ui-shadow ui-btn ui-btn-inline ui-corner-all" type="submit" id="submit-3" style="background-color:#F00; color:#FFF;">RESET PASSWORD</button>
			<div class="cb_10"></div>
            ...
            <input type="hidden" name="postid" id="postid" value="admin_triggered_pwd_reset">
...
<div id="dashboard_content_shell">
    ...
    <div id="form_shell" class="signin_shell">
        <div id="form_box">
            ...
            <div id="form_title">reset password for <?php echo $tmp_userData['FIRSTNAME_BLOB']." ".$tmp_userData['LASTNAME_BLOB']; ?></div>
            <div class="cb_5"></div>
            <div class="form_element_label">Do you wish to immediately trigger a password reset email to this user?</div>
            <div class="cb_30"></div>
        
            <form action="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/users/settings/?uid=".$oCRNRSTN_ENV->oHTTP_MGR->extractData($_GET, 'uid');  ?>" method="post" name="admin_triggered_pwd_reset" id="admin_triggered_pwd_reset"  enctype="multipart/form-data" >
               
                <div class="cb_20"></div>
                <div id="submit_shell" class="form_submit_shell" style="width:230px;">
                <div id="admin_triggered_pwd_reset_submit_btn" class="form_submit_btn" onMouseOver="mycrnrstn_fhandler.submitBtnMouseOver(this); return false;" onMouseOut="mycrnrstn_fhandler.submitBtnMouseOut(this); return false;">RESET PASSWORD</div>
                </div>
                <div class="cb_40"></div>
                ...
                <div class="hidden">
                    ...
                    <input type="hidden" name="FIRSTNAME" value="<?php echo $tmp_userData['FIRSTNAME_BLOB']; ?>">
        		    <input type="hidden" name="LASTNAME" value="<?php echo $tmp_userData['LASTNAME_BLOB']; ?>">	
                    <input name="submitin" type="submit" value="submit" onClick="mycrnrstn_fhandler.formSubmit('admin_triggered_pwd_reset'); return false;">
