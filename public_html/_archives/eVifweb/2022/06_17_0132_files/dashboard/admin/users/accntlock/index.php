...
$tmp_loop_size15 = sizeof($adminContent_ARRAY);
for($i=0;$i<$tmp_loop_size15;$i++){
...
<div data-role="page" id="myPage">
	...
	<?php 
	if($oUSER->responseString=="accnt_lock=success"){
	?>	
	<!-- 
    //
    // BEGIN MAIN CONTENT -->
	<div role="main" class="ui-content">
		<h3>Success</h3>
		<p>The user has been locked out from access to the system.</p>
		<div class="cb_10"></div>
	...
	<?php	
        ...
        <div role="main" class="ui-content">
            <h3>Error</h3>
            <p>An error was experienced when the system attempted to lock the user from the site.</p>
            <div class="cb_10"></div>
            <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/users/settings/?uid=".$tmp_userData['USERID'];  ?>" class="ui-btn ui-icon-back ui-btn-icon-left ui-corner-all">Back to User</a>
    ...
    // BEGIN MAIN CONTENT -->
	<div role="main" class="ui-content">
		<h3>lock account for <?php echo $tmp_userData['FIRSTNAME_BLOB']." ".$tmp_userData['LASTNAME_BLOB']; ?></h3>
		<p>Do you wish to immediately lock this user out of the extranet?</p>
		<div class="cb_10"></div>
      	<form action="#" method="post" name="admin_account_lock" id="admin_account_lock"  enctype="multipart/form-data" data-ajax="false">				
            
            <button class="ui-shadow ui-btn ui-btn-inline ui-corner-all" type="submit" id="submit-3" style="background-color:#F00; color:#FFF;">LOCK ACCOUNT</button>
			<div class="cb_10"></div>
            ...
            <input type="hidden" name="postid" id="postid" value="admin_account_lock">
...
<div id="dashboard_content_shell">
    ...
    <div id="form_shell" class="signin_shell">
        <div id="form_box">
            ...
            <div id="form_title">lock account for <?php echo $tmp_userData['FIRSTNAME_BLOB']." ".$tmp_userData['LASTNAME_BLOB']; ?></div>
            <div class="cb_5"></div>
            <div class="form_element_label">Do you wish to immediately lock this user out of the extranet?</div>
            <div class="cb_30"></div>
        
            <form action="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/users/settings/?uid=".$oCRNRSTN_ENV->oHTTP_MGR->extractData($_GET, 'uid');  ?>" method="post" name="admin_account_lock" id="admin_account_lock"  enctype="multipart/form-data" >
               
                <div class="cb_20"></div>
                <div id="submit_shell" class="form_submit_shell" style="width:200px;">
                <div id="admin_account_lock_submit_btn" class="form_submit_btn" onMouseOver="mycrnrstn_fhandler.submitBtnMouseOver(this); return false;" onMouseOut="mycrnrstn_fhandler.submitBtnMouseOut(this); return false;">LOCK ACCOUNT</div>
                </div>
                <div class="cb_40"></div>
                ...
                <div class="hidden">
                    ...
                    <input type="hidden" name="FIRSTNAME" value="<?php echo $tmp_userData['FIRSTNAME_BLOB']; ?>">
                    <input type="hidden" name="LASTNAME" value="<?php echo $tmp_userData['LASTNAME_BLOB']; ?>">
                    <input name="submitin" type="submit" value="submit" onClick="mycrnrstn_fhandler.formSubmit('admin_account_lock'); return false;">
