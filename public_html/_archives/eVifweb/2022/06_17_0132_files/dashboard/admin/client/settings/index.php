...
<div data-role="page" id="myPage">
	...
	<div role="main" class="ui-content">
		...
		<p>Manage the settings for this client.</p>
        <div class="ui-corner-all custom-corners">
            <div class="ui-bar ui-bar-a">
                <h3><?php echo $adminContent_ARRAY[0][$queryIndex_ARRAY['clients_COMPANYNAME_BLOB']]; ?></h3>
            </div>
            <div class="ui-body ui-body-a">
                <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/client/assetmgmt/?cid=".$adminContent_ARRAY[0][$queryIndex_ARRAY['clients_CLIENT_ID']]; ?>" class="ui-btn ui-icon-cloud ui-btn-icon-left ui-corner-all" data-ajax="false">Asset Management</a>

                <div class="cb_5"></div>
                <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/client/ipaccess/?cid=".$adminContent_ARRAY[0][$queryIndex_ARRAY['clients_CLIENT_ID']]; ?>" class="ui-btn ui-icon-forbidden ui-btn-icon-left ui-corner-all" data-ajax="false">IP Lock</a>
					
                <div class="cb_5"></div>
                <a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/client/delete/?cid=".$adminContent_ARRAY[0][$queryIndex_ARRAY['clients_CLIENT_ID']]; ?>" class="ui-btn ui-icon-delete ui-btn-icon-left ui-corner-all" style="background-color:#F00; color:#FFF;" data-ajax="false">Delete Client</a>
...
<div id="dashboard_content_shell">
	<div id="dashboard_page_title">client settings</div>
    <div class="cb_10"></div>
    <div class="copy">Manage the settings for this client.</div>
    <div class="cb_10"></div>
    <h4><?php echo $adminContent_ARRAY[0][$queryIndex_ARRAY['clients_COMPANYNAME_BLOB']]; ?></h4>
    <table>
    <tr>
    	<td style="padding-right:10px;"><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/client/";  ?>" data-ajax="false">Back to Clients</a></td>
		<td style="padding-right:10px;"><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/users/pwdreset/?uid=".$tmp_userData['USERID']; ?>"><!--Reset Password--></a></td>
				...
				?>
				<td style="padding-right:10px;"><a href="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR')."dashboard/admin/client/delete/?cid=".$adminContent_ARRAY[0][$queryIndex_ARRAY['clients_CLIENT_ID']]; ?>" style="background-color:#F00; color:#FFF; padding:5px;">Delete Client</a></td>
