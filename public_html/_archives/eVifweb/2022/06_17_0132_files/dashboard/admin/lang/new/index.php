...
<div id="form_shell" class="signin_shell">
	...
	<div id="form_box">
    	...
    	<div id="form_title">New System Language</div>
    	<div class="cb_30"></div>

        <form action="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>dashboard/admin/lang/" method="post" name="new_syslang" id="new_syslang"  enctype="multipart/form-data" >
        	<div class="form_input_shell">
                ...
                <div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="isocode" type="text" id="isocode" size="20" maxlength="100" value="" style="width:375px;" /></div>
                <div class="cb"></div>
            ...
            <div class="form_input_shell">
                ...
                <div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="isoname" type="text" id="isoname" size="20" maxlength="100" value="" style="width:375px;" /></div>
                <div class="cb"></div>
            ...
            <div class="form_input_shell">
                ...
                <div class="form_element_input"><input frm_init="crnrstn_frm_handle" crnrstn_frm_valtype="required" name="nativename" type="text" id="nativename" size="20" maxlength="100" value="" style="width:375px;" /></div>
                <div class="cb"></div>
            ...
            <tr>
                ...
                <td>
                    <div id="submit_shell" class="form_submit_shell" style="width:150px;">
                        <div id="new_syslang_submit_btn" class="form_submit_btn" onMouseOver="mycrnrstn_fhandler.submitBtnMouseOver(this); return false;" onMouseOut="mycrnrstn_fhandler.submitBtnMouseOut(this); return false;">SAVE</div>
                    </div>
            	</td>
            </tr>
            </table>
            ...
            <div class="cb_20"></div>
            <div class="hidden">
            	<input type="hidden" name="CHK_RTL" id="CHK_RTL" value="0">
                <input name="submitin" type="submit" value="submit" onClick="mycrnrstn_fhandler.formSubmit('new_syslang'); return false;">
