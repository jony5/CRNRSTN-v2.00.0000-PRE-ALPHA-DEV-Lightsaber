            ...
            <div class="cb_5"></div>
 	        <form action="<?php echo $oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP').$oCRNRSTN_ENV->getEnvParam('ROOT_PATH_CLIENT_HTTP_DIR'); ?>contact/confirm/" method="post" name="contact_home" id="contact_home"  enctype="multipart/form-data" data-ajax="false">				
                ...
                <fieldset data-role="controlgroup">
                    <input type="checkbox" name="INTEREST_WEB" id="INTEREST_WEB" checked="">
                    <label for="INTEREST_WEB"><?php echo $oUSER->getLangElem('TEXT_STRENGTHEN_WEB'); ?></label>
                    <input type="checkbox" name="INTEREST_EMAIL" id="INTEREST_EMAIL">
                    <label for="INTEREST_EMAIL"><?php echo $oUSER->getLangElem('TEXT_MARKETING_SERVICES'); ?></label>
                </fieldset>
