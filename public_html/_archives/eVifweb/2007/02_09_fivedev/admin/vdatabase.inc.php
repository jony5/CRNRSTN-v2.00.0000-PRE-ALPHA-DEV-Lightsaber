...
if($SCRIPT_NAME=="/vdatabase.inc.php"){
...
duty.  You have 30 seconds to leave.";}else{
 ...
 # connect to database
$link=mysql_connect("localhost","fivedevc_videogu","ni11cu99") or die ("Database Server Connection Failed");

mysql_select_db('fivedevc_fivevideo') or die ("Database select failed");
