				...
				<div style="clear:both; display:block;">
					...
					<div id="contentshell">
						<div id="dyncontent">
							...
							if($status=="78uihkhjh8hujkh6gffnvfjhh6"){
								//Access Denied
							...
							<table border="0" cellspacing="0" cellpadding="3">
								...
								<tr>	
									<td align="center" colspan="2">
										Don't have an account?  <a href="../client/newaccount.php">Create one here!</a>
									<br><tr><td align="right" colspan="2">
										  <a href="../client/forgotpassword.php"> Forget your username or password?</a> </p></td></tr>
									</td>
								</tr>
							</table>
							</form>
