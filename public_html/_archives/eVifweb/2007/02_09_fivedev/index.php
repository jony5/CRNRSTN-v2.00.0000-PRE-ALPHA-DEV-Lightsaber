...
function registerpage(){
		...
		var startpage=getQueryVariable('initialize');
		...
		document.getElementById('dyncontent').innerHTML = '<img src=imgs/loading.gif width=32 height=32 alt=loading... title=loading... />';
		new Ajax.Updater('dyncontent', 'content/'+startpage+'.php', {asynchronous:true, evalScripts:true});	
		new Ajax.Updater('track', 'counter/phpcounter.php', {asynchronous:true, evalScripts:true});	
				...
				<div style="clear:both; display:block;">
					...
					<div style="clear:both;">
						<div id="loginshell" style="display:none;">
							<div id="login">
								<form name="form01" action="admin/login.php" method="post" >
									<div id="signinlink"><input tabindex="3" type=image src="images/translink.gif" name="signin" value="submit" ></div>
									<input id="usernametxtbx" tabindex="1" class="logintxtbx" type="text" name="username" /> Username <br>
									<input tabindex="2" class="logintxtbx" type="password" name="password" /> Password
								</form>
							<span class="clr"></span>
							<span style="margin-left:10px;"><a href="client/newaccount.php">Create an account</a></span>							</div>
						</div>
					
						<div id="menuslidetxt"><a href="#" onclick="Effect.SlideDown('loginshell',{duration:.5}); effect_2 = Effect.SlideUp('menuslidetxt',{duration:1.0}); loginvisible=true; document.form01.username.focus(); ">login</a></div>
					</div>
					<div id="contentshell">
