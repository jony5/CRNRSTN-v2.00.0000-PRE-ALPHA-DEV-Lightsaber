...
class crnrstn_PHPMailer
{
    ...
    public function __construct($oCRNRSTN_n, $exceptions = null)
    {
        ...
        $this->SMTPDebug = self::$oCRNRSTN_n->PHPMAILER_debug_mode();
...
//            $result .= static::$LE;
     ...
     *
     * @see paravoid :: http://www.php.net/manual/en/function.mb-encode-mimeheader.php#60283
     *
     * @param string $str       multi-byte text to wrap encode
     ...
     *
     * @see Pietro Baricco :: http://www.php.net/manual/en/function.pathinfo.php#107461
     *
