...
$this->oCRNRSTN->add_resource('surely_not_fruit', $veggies);
...
$this->oCRNRSTN->add_resource('potentially_fruit', $tmp_serial . '-FRUIT');
$this->oCRNRSTN->add_resource('surely_not_fruit', $tmp_serial . '-VEGGIES');
...
for($i = 0; $i < 40; $i++){
    ...
    $tmp_serial = $this->oCRNRSTN->generate_new_key(26);
    $this->oCRNRSTN->add_resource('potentially_fruit', $tmp_serial . '-FRUITSMOOTHIE');
