...
// GRANT ACCESS
// 
#$this->ip_grant_exclusive_access([environment-key], [ip]);
...
$this->config_ip_grant_exclusive_access('LOCALHOST_PC_XP','127.0.0.1, 127.*, 128.0.4.50-128.0.4.60, 129.*-130.50.*, 130.51.10.*');
