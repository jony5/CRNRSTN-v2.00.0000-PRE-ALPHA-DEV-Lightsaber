...
$this->config_add_database_connection('BLUEHOST', 'localhost', 'jonyfivc_prod01', 'password123456789', 'jonyfivc_prod01','3306');
$this->config_add_database_connection('BLUEHOST_WWW', 'localhost', 'jonyfivc_prod01', 'password123456789', 'jonyfivc_prod01','3306');
