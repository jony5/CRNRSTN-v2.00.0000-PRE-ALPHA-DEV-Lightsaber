...
if($oCRNRSTN_USR->receive_form_integration_packet()){
    ...
    if($oCRNRSTN_USR->isvalid_data_validation_check('POST')){
        ...
        if(strlen($tmp_crnrstn_curl_uri_endpoint) > 0){
            ...
            $oCRNRSTN_USR->form_input_add('curl', 'crnrstn_curl_batch_uri_' . $tmp_batch_preview_cnt);
        ...
        $oCRNRSTN_USR->form_hidden_input_add('curl', 'crnrstn_curl_batch_count', true, $tmp_batch_preview_cnt);
...
$oCRNRSTN_USR->form_input_add('curl', 'crnrstn_curl_enable_unit_test_automation');
$oCRNRSTN_USR->form_input_add('curl', 'crnrstn_curl_unit_test_automation_freq_secs');
