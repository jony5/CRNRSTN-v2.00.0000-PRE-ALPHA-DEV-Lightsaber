...
<div id="crnrstn_curl_data_storage" style="padding:0 10px 10px 20px; width:810px;">
    ...
    <div style="border: 5px solid #F100DB; background-color: #FFF; width:100%; padding: 0 0 20px 0;">
        ...
        //echo '<img src="' . $oCRNRSTN_USR->return_creative('MYSQL_DOLPHIN', CRNRSTN_UI_IMG_BASE64) .'" height="100" >';

        echo '<div style="float: right;"><img src="' . $oCRNRSTN_USR->return_creative('REDHAT_LOGO', CRNRSTN_UI_IMG_BASE64) . '" width="103" ></div><div class="crnrstn_cb_10" style="border-bottom: 2px solid #dbdbdb;"></div>';
        echo '<div class="crnrstn_cb_30"></div>';

        echo '<div style="font-weight: bold; font-size: 20px;">Web ::</div><div class="crnrstn_cb"></div>';
        echo 'Here is the small (26px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_SMALL', 'https://soundcloud.com/jonathan-harris-772368100');
        echo '<div class="crnrstn_cb"></div>Here is the medium (50px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_MEDIUM', 'https://soundcloud.com/jonathan-harris-772368100');
        echo '<div class="crnrstn_cb"></div>Here is the large (76px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_LARGE', 'https://soundcloud.com/jonathan-harris-772368100');

        echo '<div class="crnrstn_cb_30"></div>';

        echo '<div style="font-weight: bold; font-size: 20px;">Email ::</div><div class="crnrstn_cb"></div>';
        echo 'Here is the small (26px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_SMALL', 'https://soundcloud.com/jonathan-harris-772368100', '_blank', true);
        echo '<div class="crnrstn_cb"></div>Here is the medium (50px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_MEDIUM', 'https://soundcloud.com/jonathan-harris-772368100', '_blank', true);
        echo '<div class="crnrstn_cb"></div>Here is the large (76px height) social media sticky link: ' . $oCRNRSTN_USR->return_icon_social_link('SOUNDCLOUD_LARGE', 'https://soundcloud.com/jonathan-harris-772368100', '_blank', true);
...
echo $oCRNRSTN_USR->ui_content_module_out(CRNRSTN_UI_INTERACT);
