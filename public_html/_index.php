...
RECOGNIZED COMBINATIONS OF THE SAME.
-----
case 'CRNRSTN_IMG'                          7211                RETURNS A GZIPPED (OPTIONALLY) PNG OR JPG (*CONFIGURATION DRIVEN) FILE.
...
case 'CRNRSTN_ASSET_MODE_PNG'               7511                RETURNS A GZIPPED (OPTIONALLY) PNG FILE.
case 'CRNRSTN_ASSET_MODE_JPEG'              7512                RETURNS A GZIPPED (OPTIONALLY) JPG FILE.
...
* CONFIGURATION DRIVEN:
  See $oCRNRSTN->config_init_sys_resp_return_profile() in _crnrstn.config.inc.php.
